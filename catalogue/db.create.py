...
# Connect to MongoDB using the service name in Docker
client = MongoClient("mongodb://catalogue-mongo:27017")
db = client.catalogue
...
print("Products have been added to the MongoDB database!")